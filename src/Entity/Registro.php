...
class Registro
{
     ...
     *
     * @Vich\UploadableField(mapping="registro_cali", fileNameProperty="caliName")
     *
     * @Assert\File(
     *     maxSize = "3M",
     ...
     * Set califFile
     *
     * @param File|\Symfony\Component\HttpFoundation\File\UploadedFile|null $cali
     */
    public function setCaliFile(?File $cali = null): void
    {
        $this->caliFile = $cali;
    ...
    public function getCaliFile(): ?File
    {
        return $this->caliFile;
    }


    public function getCaliName(): ?string
    {
        return $this->caliName;
    }

    public function setCaliName($caliName): void
    {
